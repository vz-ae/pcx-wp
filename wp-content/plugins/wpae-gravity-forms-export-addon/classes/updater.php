...
if( ! class_exists('PMGFE_Updater') ) {
    ...
    class PMGFE_Updater {
        ...
        public function plugin_row_meta( $links, $file ) {
            if ( $file == $this->name ) {
                $row_meta = array(
                    'changelog'    => '<a href="' . admin_url( 'plugin-install.php?tab=plugin-information&plugin=wpae-gf-addon&section=changelog&TB_iframe=true&width=772&height=477' ) . '" class="thickbox open-plugin-details-modal" title="' . esc_attr( __( 'View WP All Export - Gravity Forms Add-On Changelog', 'wp_all_export_woocommerce_add_on' ) ) . '">' . __( 'Changelog', 'wp_all_export_woocommerce_add_on' ) . '</a>',
                );
