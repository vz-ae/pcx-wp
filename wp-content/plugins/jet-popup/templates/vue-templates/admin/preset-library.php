...
<div class="jet-popup-library-page__inner">
    ...
    <div class="jet-popup-library-page__header">
        <h1 class="jet-popup-library-page__title"><?php esc_html_e( 'Presets Library', 'jet-popup' ); ?></h1>
        <p class="jet-popup-library-page__desc"><?php esc_html_e( 'In Popup Library, you can select the pre-designed popups that can be used as presets for your new popups.', 'jet-popup' ); ?></p>
    </div>
    ...
    >
        <div class="panel">
            <div v-if="categoriesLoaded" class="jet-popup-library-page__filters">
                ...
                <div v-if="isContentTypeFilter" class="jet-popup-library-page__filters-content-type">
                    <span><b><?php esc_html_e( 'Content Type: ', 'jet-popup' ); ?></b></span>
                    <cx-vui-select
                        :prevent-wrap="true"
                        :options-list="contentTypeOptions"
                        v-model="contentType"
                        @on-change="contentTypeHandler"
                    >
                    </cx-vui-select>
                </div>
        ...
        <div class="panel" v-if="isShowPagination">
            <div class="jet-popup-library-page__pagination">
                <cx-vui-pagination
                    :current="page"
                    :total="presetsLength"
                    :page-size="perPage"
    ...
    <cx-vui-popup
        class="jet-popup-library-page__popup"
        v-model="installPopupVisible"
        body-width="500px"
        ok-label="<?php esc_html_e( 'Install Popup', 'jet-popup' ); ?>"
        @on-ok="createPopup"
    >
        ...
        <div slot="content">
            ...
            <div class="jet-popup-library-page__required-plugins" v-if="presetRequiredPlugins">
                <p><?php esc_html_e( 'You can also install additional plugins needed for this preset.', 'jet-popup' ); ?></p>
                <div class="jet-popup-library-page__required-plugins-list">
                    <required-plugin
                        v-for="plugin in presetRequiredPlugins"
                        :key="plugin"
                        :plugin="plugin"
                    >
                    </required-plugin>
