 ...
 */
class PMTI_Model_List extends PMTI_Model {
	...
	public function convertRecords($elementClass = NULL, $includeFields = NULL) {
		...
		if ( ! is_subclass_of($elementClass, PMTI_Plugin::PREFIX . 'Model_Record')) {
			throw new Exception("Provideded class name $elementClass must be a subclass of " . PMTI_Plugin::PREFIX . 'Model_Record');
		}
