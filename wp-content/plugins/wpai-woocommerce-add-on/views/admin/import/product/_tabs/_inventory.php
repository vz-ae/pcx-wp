<div class="panel woocommerce_options_panel" id="inventory_product_data" style="display:none;">
	...
	<div class="options_group">
		...
		<p class="form-field wpallimport-radio-field">
			...
			<a href="#help" class="wpallimport-help" title="<?php _e('Set the stock status to In Stock for positive Stock Qty values, and Out Of Stock if Stock Qty is 0 or blank.', PMWI_Plugin::TEXT_DOMAIN) ?>" style="position:relative; top:2px;">?</a>
		</p>
		<div class="form-field wpallimport-radio-field">
