 ...
 */
class PMGI_Model_List extends PMGI_Model {
	...
	public function convertRecords($elementClass = NULL, $includeFields = NULL) {
		...
		if ( ! is_subclass_of($elementClass, PMGI_Plugin::PREFIX . 'Model_Record')) {
			throw new Exception("Provideded class name $elementClass must be a subclass of " . PMGI_Plugin::PREFIX . 'Model_Record');
		}
