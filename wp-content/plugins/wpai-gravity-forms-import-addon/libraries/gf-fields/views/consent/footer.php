    ...
    <div class="switcher-target-is_multiple_field_value_<?php echo $field->id;?>_no">
        <div class="input sub_input">
            <div class="input">
                ...
                <a href="#help" class="wpallimport-help" style="top:0;" title="<?php _e('Specify the value. Use \'1\' or \'yes\' for checked and any other value for unchecked.', 'wp_all_import_gf_add_on'); ?>">?</a>
            </div>
        </div>
    </div>
</div>